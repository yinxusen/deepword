...
./bin/run.sh python/deeptextworld/main.py \
    ...
    --annealing_eps_t 2000000 --annealing_gamma_t 2000 --observation_t 10000 --replay_mem 500000 \
    --embedding_size 64 --save_gap_t 10000 --batch_size 32 \
    --game_episode_terminal_t 100 --eval_episode 10 --model_creator CNNEncoderDRRN
popd
